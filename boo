            ...
            if itemName and itemAmount then
                ...
                if connectedInventory then
                    ...
                    if addedAmount > 0 then
                        ...
                        chatBox.sendMessageToPlayer("Failed to add the item to your inventory. Make sure there's enough space in your inventory.", username)
                    end
                else
